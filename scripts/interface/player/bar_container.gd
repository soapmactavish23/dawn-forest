...
onready var health_bar: TextureProgress = $HealthBarBackground/HealthBar
onready var mana_bar: TextureProgress = $ManaBarBackground/ManaBar
onready var exp_bar: TextureProgress = $ExpBarBackground/ExpBar
